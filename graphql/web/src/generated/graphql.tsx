...
export type CutQuery = { __typename?: 'Query' } & {
  cut?: Maybe<
    { __typename?: 'Cut' } & Pick<Cut, 'id' | 'src'> & {
        film?: Maybe<{ __typename?: 'Film' } & Pick<Film, 'id' | 'title'>>;
      }
  >;
};
...
export type CutsQuery = { __typename?: 'Query' } & { cuts: Array<{ __typename?: 'Cut' } & Pick<Cut, 'id' | 'src'>> };

export type FilmQueryVariables = Exact<{
  filmId: Scalars['Int'];
}>;

export type FilmQuery = { __typename?: 'Query' } & {
  film?: Maybe<
    { __typename?: 'Film' } & Pick<
      Film,
      'id' | 'title' | 'subtitle' | 'description' | 'genre' | 'runningTime' | 'posterImg' | 'release'
    > & { director: { __typename?: 'Director' } & Pick<Director, 'id' | 'name'> }
  >;
};
...
export type FilmsQuery = { __typename?: 'Query' } & {
  films: { __typename?: 'PaginatedFilms' } & Pick<PaginatedFilms, 'cursor'> & {
      films: Array<
        { __typename?: 'Film' } & Pick<Film, 'id' | 'title' | 'subtitle' | 'runningTime' | 'release' | 'posterImg'> & {
            director: { __typename?: 'Director' } & Pick<Director, 'name'>;
          }
      >;
    };
};
